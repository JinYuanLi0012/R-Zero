...
def build_command(args: argparse.Namespace) -> list[str]:
    ...
    overrides = {
        ...
        "actor_rollout_ref.actor.clip_ratio": algorithm["ppo_clip_ratio"],
        "actor_rollout_ref.actor.clip_ratio_low": algorithm["ppo_clip_ratio_low"],
        "actor_rollout_ref.actor.clip_ratio_high": algorithm["ppo_clip_ratio_high"],
        "actor_rollout_ref.actor.clip_ratio_c": algorithm["ppo_clip_ratio_c"],
        ...
        "actor_rollout_ref.rollout.temperature": algorithm["training_rollout_temperature"],
        "actor_rollout_ref.rollout.top_p": algorithm["training_rollout_top_p"],
        "actor_rollout_ref.rollout.seed": algorithm["training_rollout_seed"],
